...
public class Config {
    ...
    public static final String SUBCATEGORY_GRINDER = "grinder";
    public static ForgeConfigSpec.IntValue GRINDER_MAXCAP;
    private static int GRINDER_MAXCAP_DEFAULT = 100000;
    ...
    private static void setupGrinderConfig() {
        COMMON_BUILDER.comment("Grinder Settings").push(SUBCATEGORY_GRINDER);
        GRINDER_MAXCAP = COMMON_BUILDER
                .comment("Grinder Max Capacity\n" + "Default: " + GRINDER_MAXCAP_DEFAULT)
                .defineInRange("maxPower", GRINDER_MAXCAP_DEFAULT, 0, Integer.MAX_VALUE);
        COMMON_BUILDER.pop();
    }
