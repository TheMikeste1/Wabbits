 ...
 * {@link net.minecraft.entity.Entity} that places it on the horizontal plane
 * only, or away if they're sneaking.
 *
 * @see FacedBlock
 */
public class HorizontalFacedBlock extends Block {
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, BlockState state, @Nullable LivingEntity placer, ItemStack stack) {
        ...
        if (placer.isSneaking()) {
            direction = Functions.getHorizontalDirectionAwayFromEntity(pos, placer);
        } else {
            direction = Functions.getHorizontalDirectionTowardsEntity(pos, placer);
        }
