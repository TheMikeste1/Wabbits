...
public class GrinderContainer extends Container {
    ...
    public GrinderContainer(int id, PlayerInventory playerInventory, World world, BlockPos pos) {
        super(ContainerTypes.grinder, id);
    ...
    public ItemStack transferStackInSlot(PlayerEntity playerIn, int index) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (index == 0) {
                ...
                if (accepted.get()) {
                    if (!this.mergeItemStack(stack, 0, 1, false)) { //inclusive-exclusive
                        return ItemStack.EMPTY;
                    }
                } else if (index < 29) {
